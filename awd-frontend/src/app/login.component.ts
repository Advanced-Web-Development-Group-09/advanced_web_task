        ...
        <div class="form-wrapper">
          ...
          <form [formGroup]="loginForm" (ngSubmit)="onSubmit()">
            <div class="input-group">
              ...
              <input id="email" type="email" formControlName="username" placeholder="kastene@uni-hildesheim.de">
            </div>
          ...
          <p class="footer-text">
            Dont have an Account yet? <a routerLink="/register"><strong>Register now!</strong></a>
          </p>
        </div>
      </section>
    </div>
